...
import htmlLang from 'react-syntax-highlighter/dist/cjs/languages/hljs/xml';
import jsxLang from 'react-syntax-highlighter/dist/cjs/languages/hljs/javascript';
import scssLang from 'react-syntax-highlighter/dist/cjs/languages/hljs/scss';
				...
				{!hasTab ? (
					...
					<>
						<CardHeader borderSize={1}>
							<CardActions>
								{Children.map(
									children as ReactElement<ICardTabItemProps>[],
									(item, index) => (
										<Button
											key={item.props.id}
											isLight
