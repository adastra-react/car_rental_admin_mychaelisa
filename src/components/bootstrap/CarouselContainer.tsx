...
import CarouselItem, { TCarouselItemProps } from './CarouselItem';
...
class CarouselContainer extends Component<TCarouselContainerProps, TCarouselContainerState> {
	...
	renderItems(
		carouselItems: React.ReactElement<TCarouselItemProps>[],
	...
	static defaultProps: Partial<TCarouselContainerProps> = {
		interval: 5000,
		pause: 'hover',
		keyboard: true,
		slide: true,
