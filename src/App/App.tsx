...
const App = () => {
	...
	// react-use's useFullscreen types the ref as non-nullable, which doesn't
	// match a real DOM ref before mount.
	useFullscreen(ref as RefObject<Element>, fullScreenStatus, {
