...
export function getServiceDataWithServiceName(serviceName: string): IServiceProps | undefined {
	const key = Object.keys(SERVICES).find((f) => SERVICES[f].name.toString() === serviceName);
