...
// Car Rental Admin Panel — the sidebar nav actually shown to the client.
// Everything above this line is the original Facit template's demo/documentation
// content, kept in place (unused in the nav) in case any of it is worth reusing later.
export const carRentalMenu = {
	dashboard: {
		id: 'dashboard',
		text: 'Dashboard',
	...
	// Later slices: Listings, Bookings, Disputes, Payouts, Pickup Points, Chat Moderation Logs
};
